    ...
    return (
      <div>
        ...
        >
          ...
          {
            (getFieldValue('maritalStatus') && getFieldValue('maritalStatus').indexOf(0)>=0) ?
              <div>
                <Form.Item
                  label="是否必须配偶同意贷款"
                  {...formItemLayout}
          ...
          </Form.Item>
          {
            getFieldValue('occupation').indexOf(0)>=0 || getFieldValue('occupation').indexOf(2)>=0 ?
              <div>
                ...
                {
                  getFieldValue('isProvidentFund').indexOf(0)<0 && getFieldValue('isProvidentFund').indexOf(1)>=0?
                    <div>
                      <Form.Item
                        label="现单位公积金缴纳基数要求"
                        {...formItemLayout}
